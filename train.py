...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Parse hypeparameter arguments")
    parser.add_argument("--use_config_file", type=lambda x: (str(x).lower() == 'true'), default=True)
    parser.add_argument("--model_alias", type=str)
    parser.add_argument("--batch_size", type=int, default=16)
    parser.add_argument("--load_cached", type=lambda x: (str(x).lower() == 'true'), default=False)
    parser.add_argument("--embedding_size", type=int, default=512)
    parser.add_argument("--num_parts_encoder", type=int, default=6)
    parser.add_argument("--num_parts_decoder", type=int, default=6)
    ...
    parser.add_argument("--smoothing", type=lambda x: (str(x).lower() == 'true'), default=True)
    parser.add_argument("--smoothing_coeff", type=float, default=True)
